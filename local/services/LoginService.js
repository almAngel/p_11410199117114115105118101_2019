...
class HomeService {
    ...
    static deleteUser() {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            this.userDAO = new GenericDAO_1.GenericDAO(UserSchema_1.UserSchema);
            response = yield this.userDAO.delete(AbstractController_1.AbstractController.metadata("urlParams").id);
            DatabaseManager_1.DatabaseManager.disconnect();
            return response;
        });
    }
    static updateUser() {
        return __awaiter(this, void 0, void 0, function* () {
            let response;
            this.userDAO = new GenericDAO_1.GenericDAO(UserSchema_1.UserSchema);
            response = yield this.userDAO.saveOrUpdate(AbstractController_1.AbstractController.metadata("request").body, AbstractController_1.AbstractController.metadata("urlParams").id);
            DatabaseManager_1.DatabaseManager.disconnect();
            return response;
        });
    }
