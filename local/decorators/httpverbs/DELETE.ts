...
export function DELETE({ path, produces = ContenType.TEXT_PLAIN, sealed = false }: { path: string; produces?: ContenType; sealed?: boolean }) {
    ...
    return function (target: any, propertyKey: string, descriptor: PropertyDescriptor): any {
        ...
        descriptor.value = function (...args: any[]) {
            ...
            result = ServerManager.getInstance().delete(finalPath, (req: any, res: any, next: any) => {
                //Response reset
                response = "";
